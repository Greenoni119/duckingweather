...
const WeatherDetails: React.FC<WeatherDetailsProps> = ({ data }) => {
  ...
  return (
    <div className="p-2 ">
      <h1 className="mb-6 text-4xl titletext italic font-bold text-center md:text-left">
        Specs:
      </h1>

      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 text-center italic font-bold">
        <div className="card-bg  flex p-4 items-center justify-center gap-6 rounded-xl">
          <div className="text-xl">
            <h3 className="titletext">Wind Speed</h3>
            <h3
              className="subtext rounded-xl mt-1"
        ...
        <div className="card-bg  flex p-4 items-center justify-center gap-6 rounded-xl">
          <div className="text-xl">
            <h3 className="titletext">Humidity</h3>
            <h3
              className="subtext rounded-xl mt-1"
        ...
        <div className="card-bg  flex p-4 items-center justify-center gap-6 rounded-xl">
          <div className="text-xl">
            <h3 className="titletext">Wind Direction</h3>
            <h3
              className="subtext rounded-xl mt-1"
        ...
        <div className="card-bg  flex p-4 items-center justify-center gap-6 rounded-xl">
          <div className="text-xl">
            <h3 className="titletext">Sunrise</h3>
            <h3
              className="subtext rounded-xl mt-1 px-2"
        ...
        <div className="card-bg  flex p-4 items-center justify-center gap-6 rounded-xl">
          <div className="text-xl">
            <h3 className="titletext">Sunset</h3>
            <h3
              className="subtext rounded-xl mt-1 px-2"
        ...
        <div className="card-bg  flex p-4 items-center justify-center gap-6 rounded-xl">
          <div className="text-xl">
            <h3 className="titletext">Air Pressure</h3>
            <h3
              className="subtext rounded-xl mt-1"
        ...
        <div className="card-bg  flex p-4 items-center justify-center gap-6 rounded-xl">
          <div className="text-xl">
            <h3 className="titletext">Feels Like</h3>
            <h3
              className="subtext rounded-xl mt-1"
        ...
        <div className="card-bg  flex p-4 items-center justify-center gap-6 rounded-xl">
          <div className="text-xl">
            <h3 className="titletext">Visibility</h3>
            <h3
              className="subtext rounded-xl mt-1"
